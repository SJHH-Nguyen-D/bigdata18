 ...
 */
      ...
      __pyx_t_23 = -1;
      if (__pyx_t_21 < 0) {
        __pyx_t_21 += __pyx_pybuffernd_D.diminfo[0].shape;
        if (unlikely(__pyx_t_21 < 0)) __pyx_t_23 = 0;
      } else if (unlikely(__pyx_t_21 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_23 = 0;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_pybuffernd_D.diminfo[1].shape;
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_23 = 1;
      } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_23 = 1;
      if (unlikely(__pyx_t_23 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_23);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      __pyx_t_24 = __pyx_v_im;
      __pyx_t_25 = __pyx_v_j;
      __pyx_t_23 = -1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_pybuffernd_D.diminfo[0].shape;
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_23 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_23 = 0;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_pybuffernd_D.diminfo[1].shape;
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_23 = 1;
      } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_23 = 1;
      if (unlikely(__pyx_t_23 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_23);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      ...
      } else if (unlikely(__pyx_t_26 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_23 = 0;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_pybuffernd_D.diminfo[1].shape;
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_23 = 1;
      } else if (unlikely(__pyx_t_27 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_23 = 1;
      if (unlikely(__pyx_t_23 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_23);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      __pyx_t_28 = __pyx_v_im;
      __pyx_t_29 = __pyx_v_jm;
      __pyx_t_23 = -1;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_pybuffernd_D.diminfo[0].shape;
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_23 = 0;
      } else if (unlikely(__pyx_t_28 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_23 = 0;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_pybuffernd_D.diminfo[1].shape;
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_23 = 1;
      } else if (unlikely(__pyx_t_29 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_23 = 1;
      if (unlikely(__pyx_t_23 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_23);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      ...
      } else if (unlikely(__pyx_t_30 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_23 = 0;
      if (__pyx_t_31 < 0) {
        __pyx_t_31 += __pyx_pybuffernd_D.diminfo[1].shape;
        if (unlikely(__pyx_t_31 < 0)) __pyx_t_23 = 1;
      } else if (unlikely(__pyx_t_31 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_23 = 1;
      if (unlikely(__pyx_t_23 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_23);
        __PYX_ERR(0, 60, __pyx_L1_error)
      }
      *__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_31, __pyx_pybuffernd_D.diminfo[1].strides) = ((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_D.diminfo[1].strides)) + __pyx_f_3dtw_min_c(__pyx_f_3dtw_min_c((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_25, __pyx_pybuffernd_D.diminfo[1].strides)), (*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_27, __pyx_pybuffernd_D.diminfo[1].strides))), (*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_D.diminfo[1].strides))));
    }
 ...
 */
  ...
  __pyx_t_33 = __pyx_v_ly;
  __pyx_t_4 = -1;
  if (__pyx_t_32 < 0) {
    __pyx_t_32 += __pyx_pybuffernd_D.diminfo[0].shape;
    if (unlikely(__pyx_t_32 < 0)) __pyx_t_4 = 0;
  } else if (unlikely(__pyx_t_32 >= __pyx_pybuffernd_D.diminfo[0].shape)) __pyx_t_4 = 0;
  if (__pyx_t_33 < 0) {
    __pyx_t_33 += __pyx_pybuffernd_D.diminfo[1].shape;
    if (unlikely(__pyx_t_33 < 0)) __pyx_t_4 = 1;
  } else if (unlikely(__pyx_t_33 >= __pyx_pybuffernd_D.diminfo[1].shape)) __pyx_t_4 = 1;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_4);
    __PYX_ERR(0, 65, __pyx_L1_error)
  }
  __pyx_t_12 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(double *, __pyx_pybuffernd_D.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_D.diminfo[0].strides, __pyx_t_33, __pyx_pybuffernd_D.diminfo[1].strides))); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_10 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_8))) {
 ...
 *     # if not permute
 */
  __pyx_tuple__13 = PyTuple_Pack(19, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_w, __pyx_n_s_X, __pyx_n_s_Y, __pyx_n_s_t, __pyx_n_s_r, __pyx_n_s_c, __pyx_n_s_im, __pyx_n_s_jm, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_lx, __pyx_n_s_jstart, __pyx_n_s_jstop, __pyx_n_s_idx_inf_left, __pyx_n_s_ly, __pyx_n_s_curr, __pyx_n_s_D); if (unlikely(!__pyx_tuple__13)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__13);
  __Pyx_GIVEREF(__pyx_tuple__13);
  __pyx_codeobj__14 = (PyObject*)__Pyx_PyCode_New(3, 0, 19, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dtw_pyx, __pyx_n_s_dynamic_time_warping, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__14)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
